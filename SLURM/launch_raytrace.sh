...
#SBATCH --cpus-per-task=25  # This for multi threading. How many CPUS to use
...
srun --cpu-bind=cores ../build/bounce_map_example /scratch/msantana/PatchFoldersRefined/PlaneWithNacelleMoreRefinedReordered/ patch_ 1 134 /scratch/msantana/RayTracing/Plane_by_patchv2.vtk
date
