...
srun --cpu-bind=cores ../build/bounce_map_example /scratch/msantana/PatchFoldersRefined/PlaneWithNacelleFirst/ patch_ 1 4212 /scratch/msantana/RayTracing/Plane_by_patch_60_fixed.vtk /scratch/msantana/RayTracing/RaysPlane/
date
